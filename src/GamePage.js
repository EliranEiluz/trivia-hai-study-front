...
function GamePage({ nowOnline }) {
    ...
    const [currentQuestion, setCurrentQuestion] = useState('When did Israel Declared independence?');
    ...
    return (
        <>
            ...
            <div class="modal fade" id="leaveGameModal" tabindex="-1" aria-labelledby="leaveGameModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="leaveGameModalLabel">Leave Game</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onClick={leaveGame}>Leave Game</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="leaveToHomeGameModal" tabindex="-1" aria-labelledby="leaveToHomeGameModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="leaveToHomeGameModalLabel">Back to Home Page</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onClick={leaveToHomeGame}>Back to home page</button>
                        </div>
                    </div>
                </div>
            </div>

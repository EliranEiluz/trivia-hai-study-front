                    ...
                    <div className="modal-content" id="chooseTrainingModalBody">
                        ...
                        <div className="modal-body container-fluid">
                            <div className='row'>
                                ...
                                <div className='col-6'>
                                    <center>
                                        <button type="button" className="btn choose-mode-btn" data-bs-toggle="collapse" data-bs-target="#singlePlayerOptions" aria-expanded="false" aria-controls="singlePlayerOptions" disabled={false}>{t('single_player')}</button>
                                    </center>
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col-12' id="collapseGroup">
                                    ...
                                    <div id="PlayAgainstAgentOptions" className='collapse' data-bs-parent='#collapseGroup'>
                                        <div className='card card-body' id="gameModeMenu">
                                            <div>
                                                <center>
                                                    <button id="PlayAgainstAgent" type="button" data-tippy-content={t('0_gameMode_tooltip')} className="btn choose-mode-btn gameTypeOptionBtn" data-bs-dismiss="modal" onClick={onPlayAgainstAgent} disabled={false}>{t('play_alone')}</button>
                                                </center>
                                            </div>
                                            <div>
                                                <center>
                                                    <button id="PlayAgainstAgentWithAgent" type="button" data-tippy-content={t('1_gameMode_tooltip')} className="btn choose-mode-btn gameTypeOptionBtn" data-bs-dismiss="modal" onClick={onPlayAgainstAgentWithAgent} disabled={false}>{t('play_with_agent')}</button>
                                                </center>
                                            </div>
                                            <div>
                                                <center>
